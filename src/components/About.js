...
export const About = () => {
  return <section className="about" id="about">
      ...
      <p className="about__paragraph">
        I focus on usability and development with especial interest in the
        ...
        navigation through the products is very important, because I think the
        user is the center of the product.
      </p>
      <p className="about__paragraph">
      ...
      <ul className="about__skills">
        ...
        <li>
          <strong>Frameworks:</strong> Bootstrap 4 - Jquery - AJAX - Sinatra - Ruby on Rails - Wordpress.
        </li>
        <li>
          <strong>Methodologies:</strong> BEM - Responsive design - TDD - REST API’s - Scrum.
        </li>
      </ul>
    </section>
}